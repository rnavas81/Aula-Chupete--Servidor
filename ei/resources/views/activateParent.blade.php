...
<body class="">
    <div class="container">
        ...
        <p class='parrafo'>
            ...
            <br>
            Nos complace darle la bienvenida a nuestra aplicación y que a partir de ahora pueda consultar todo lo que hace su hijo en su aula.
        </p>
        @if (isset($password))
        <p class='parrafo'>
            Su contraseña para acceder es: <b>{{$password}}</b>
        </p>
        @endif
        @if (isset($url))
        <p class='parrafo'>
